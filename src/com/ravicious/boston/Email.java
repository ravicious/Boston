...
public class Email extends Activity implements View.OnClickListener {
	...
	private void initializeVariables() {
		personsEmail = (EditText) findViewById(R.id.editTextEmails);
		intro = (EditText) findViewById(R.id.editTextIntro);
		personsName = (EditText) findViewById(R.id.editTextName);
		stupidThings = (EditText) findViewById(R.id.editTextThings);
		hatefulAction = (EditText) findViewById(R.id.editTextAction);
		outro = (EditText) findViewById(R.id.editTextOutro);
